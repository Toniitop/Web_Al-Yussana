                        ...
                        <li className="relative">
                            ...
                            <div id="dropdownNavbar" className={`z-10 ${isDropdownOpen ? '' : 'hidden'} md:absolute mt-2 bg-green-500 divide-y divide-gray-100 rounded-lg shadow w-44`}>
                                <ul className="py-2 text-sm text-gray-700" aria-labelledby="dropdownLargeButton">
                                    <li>
                                        <a href="#" className="text-white block px-4 py-2 hover:bg-green-400">Dashboard</a>
                                    </li>
                                    <li>
                                        <a href="#" className="text-white block px-4 py-2 hover:bg-green-400">Settings</a>
                                    </li>
                                    <li>
                                        <a href="#" className="text-white block px-4 py-2 hover:bg-green-400">Earnings</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
