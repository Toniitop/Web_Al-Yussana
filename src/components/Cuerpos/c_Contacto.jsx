...
function c_Contacto() {
    return (
        <div className="space-y-12 bg-gray-300">
            ...
            {/* Sección 1: Header */}
            <header className="relative bg-center bg-cover text-white text-center h-96" style={{ backgroundImage: `url(/fondo1.png)` }}>
            ...
            {/* Sección 2: Mapa y lista */}
            <section className="bg-green-800 rounded-lg p-6 flex flex-col lg:flex-row items-center mx-4 sm:mx-6 lg:mx-12 xl:mx-24">
                <div className="flex-1">
                    <p className="text-2xl font-bold text-white text-center lg:text-left">
                        <span className="underline">Información</span>
                        <br />
                        <ul className="max-w-lg mx-auto lg:mx-0">
                            <li className="pb-3 sm:pb-4">
                                <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
                            ...
                            <li className="pb-3 sm:pb-4">
                                <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
                                    ...
                                    <a href="mailto:info@alyussana.com" className="mt-8 sm:mt-0 group/a relative inline-flex items-center justify-center overflow-hidden rounded-md bg-green-400/30 backdrop-blur-lg px-6 py-2 text-base font-semibold text-white transition-all duration-300 ease-in-out hover:scale-110 hover:shadow-xl hover:shadow-green-200/50 border border-white/20">
                ...
                <div className="flex-1 mt-8 lg:mt-0">
                    <div className="flex justify-center items-center lg:justify-end">
                        <iframe
                            ...
                            className="w-full lg:w-96 h-96 rounded-lg shadow-lg"
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3189.832490326188!2d-4.496507324869854!3d37.407968232211026!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd6dc62da0244997%3A0x10f17fadb72a96d8!2sRda.%20P%C2%BA%20Viejo%2C%202%2C%2014900%20Lucena%2C%20C%C3%B3rdoba%2C%20Spain!5e0!3m2!1sen!2sus!4v1690200482255!5m2!1sen!2sus"
                            loading="lazy"
